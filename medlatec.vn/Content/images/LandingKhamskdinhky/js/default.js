(function($) {
    ...
    $(document).ready(function() {
        ...
        //doitac
        if($('.doitac .doitac-slider').length > 0) {
        ...
        // more service
        if($('.more_service .slider_service').length > 0) {
        ...
        if($('.introduce .introduce_slider').length > 0) {
            $('.introduce_slider').owlCarousel({
                autoplay: false,
                loop: true,
                margin:10,
                nav: true,
        ...
        // chuyengia
         if($('.chuyengia .chuyengia_slider').length > 0) {
            $('.chuyengia_slider').owlCarousel({
                autoplay: false,
                loop: true,
                margin:10,
                nav: true,
        ...
        $owl.children().each( function( index ) {
          ...
          var $speed = 300;  
          $owl.trigger('to.service_slider', [$(this).data( 'position' ), $speed] );
 

          $('.tt_ser').removeClass('active');
          $('#'+$owl.find('.center').find('img').attr('data-id')).addClass('active');
      });


        //procedure
        if($('.procedure .procedure_slider').length > 0) {
            $('.procedure_slider').owlCarousel({
                autoplay: false,
                loop: true,
                margin:10,
                nav: false,

(function($) {
    ...
    $(document).ready(function() {
        ...
        if($('.slider_s1').length > 0) {
            $('.slider_s1').owlCarousel({
                autoplay: false,
                autoplayTimeout:5000,
                loop: true,
                nav: false,
        ...
        // more service
        if($('.slider_s2').length > 0) {
            $('.slider_s2').owlCarousel({
                // autoplay: true,
                loop: true,
                margin:10,
                nav: false,
        ...
        if($('.slider_s3').length > 0) {
            $('.slider_s3').owlCarousel({
                autoplay: false,
                loop: true,
                margin:10,
                nav: false,
        ...
        // chuyengia
         if($('.slider_s5').length > 0) {
            $('.slider_s5').owlCarousel({
                autoplay: false,
                loop: true,
                margin:10,
                nav: false,
